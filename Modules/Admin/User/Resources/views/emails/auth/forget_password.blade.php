              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="{{$data['home_link']}}" style="color:#6C5BF7;text-decoration:none;border-radius: 5px; border: 2px solid #6C5BF7;padding:0.5rem 2rem;">Manasaa Home Page</a></p>                
